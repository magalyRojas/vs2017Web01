...
namespace App.UI.Web.MVC.Filters
{
    public class LoggingFilterAttribute: ActionFilterAttribute
    {
        ...
        {
            var message = $"Iniciando la ejecución del controlador:" + $"{filterContext.ActionDescriptor.ControllerDescriptor.ControllerName}" +
        ...
        {
            var message = $"Finalizando la ejecución del controlador:" + $"{filterContext.ActionDescriptor.ControllerDescriptor.ControllerName}" +
            $", Action:{filterContext.ActionDescriptor.ActionName}" +
