...
namespace App.Data.Repository
{
            ...
            where TEntity : class
    {
        ...
        /// <summary>
        /// Metodo para obtener una lista de datos por filtro
        /// </summary>
        /// <param name="predicate"></param>
        /// <param name="includes"></param>
        /// el include incluye las tablas que estan relacionadas
        /// <returns></returns>
        //public IEnumerable<TEntity> GetAll(
        //    Expression<Func<TEntity, bool>> predicate = null, List<string> includes = null)
        //{
        ...
        //    if (includes!= null)
        //    {
        //        foreach(var tableInclude in includes)
        //        {
